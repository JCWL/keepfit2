var myNull = "this is test frunt watch";;var myApp = angular.module('startApp', ['ui.router', 'onsen']);
/**
...
;;var fac = "henhao";//请尝试把BookListCtrl中加载书籍列表数据的部分抽出来作为一个服务